...
$educationData = getCvDataBySection('education');
?>
...
<head>
    ...
    <title>Riwayat Pendidikan - Nena Fernanda</title>
    <!-- Bootstrap 5 CSS -->
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav mx-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="education.php"><i class="bi bi-mortarboard me-1"></i> Pendidikan</a>
                    </li>
                    <li class="nav-item">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <div class="card p-4">
                        ...
                        <?php foreach($educationData as $item): ?>
