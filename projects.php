...
$projectsData = getCvDataBySection('projects');
?>
...
<head>
    ...
    <title>Pengalaman Proyek - Nena Fernanda</title>
    <!-- Bootstrap 5 CSS -->
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav mx-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="projects.php"><i class="bi bi-briefcase me-1"></i> Proyek</a>
                    </li>
                    <li class="nav-item">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-10">
                    <div class="card p-4 card-float">
                        <h2 class="section-title text-center">Pengalaman / Proyek</h2>
                        
                        <div class="row">
                            <?php foreach($projectsData as $item): ?>
                                <div class="col-md-6 mb-4">
                                    <div class="card project-card h-100 card-float">
                                        <div class="card-body">
                                            <h5 class="card-title"><i class="bi bi-briefcase text-primary me-2"></i><?php echo htmlspecialchars($item['title']); ?></h5>
                                            <p class="card-text"><?php echo htmlspecialchars($item['content']); ?></p>
                                            <div class="d-flex justify-content-end">
                                                <span class="badge bg-primary"><i class="bi bi-tools me-1"></i>Project</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
