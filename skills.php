...
<head>
    ...
    <title>Keahlian - Nena Fernanda</title>
    <!-- Bootstrap 5 CSS -->
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav mx-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="skills.php"><i class="bi bi-tools me-1"></i> Keahlian</a>
                    </li>
                    <li class="nav-item">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-10">
                    <div class="card p-4 card-float">
                        <h2 class="section-title text-center">Keahlian / Skill</h2>
                        ...
                        foreach($skillsData as $item) {
                            $title = $item['title'];
                            if (!isset($uniqueSkills[$title])) {
                                $uniqueSkills[$title] = [];
                            }
                            $uniqueSkills[$title][] = $item['content'];
                        }
                        ?>
                        
                        <?php foreach($uniqueSkills as $skill => $descriptions): ?>
                            <div class="skill-category card-float">
                                <h4 class="text-primary"><i class="bi bi-star-fill text-warning me-2"></i><?php echo htmlspecialchars($skill); ?></h4>
                                <?php foreach($descriptions as $desc): ?>
                                    <div class="mb-3">
                                        <div class="d-flex justify-content-between mb-1">
                                            <span><i class="bi bi-check-circle-fill text-success me-2"></i><?php echo htmlspecialchars($desc); ?></span>
                                        </div>
                                    </div>
                                <?php endforeach; ?>
                            </div>
                        ...
                        <div class="text-center mt-4">
                            <a href="index.php" class="btn btn-secondary btn-glow">Kembali ke Beranda</a>
                        </div>
                    </div>
                </div>
            </div>
